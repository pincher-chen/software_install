$ cd arch
$ cat Linux-x86-64-intel-mic.psmp 
```
...
LIBINTROOT = /NSFCGZ/app/libint/1.1.5
#LIBINTROOT = /WORK/app/libint/1.1.5
...
LIBXCROOT = /NSFCGZ/app/libxc/2.2.2
...
# $ make clean
#
#LIBXSTREAMROOT = /HOME/nscc_ts_1/ljh/cp2k-code-17116-trunk/cp2k/tools/mic/libxstream
...
#  DFLAGS  += -D__LIBINT -D__LIBINT_MAX_AM=6 -D__LIBDERIV_MAX_AM1=5
  DFLAGS  += -D__LIBINT -D__LIBINT_MAX_AM=5 -D__LIBDERIV_MAX_AM1=4
...
```
$cd makefiles
$ make -j 16 ARCH=Linux-x86-64-intel-host VERSION=psmp
